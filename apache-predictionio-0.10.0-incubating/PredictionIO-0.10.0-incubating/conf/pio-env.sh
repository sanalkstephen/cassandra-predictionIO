...
PIO_STORAGE_REPOSITORIES_EVENTDATA_SOURCE=CASSANDRA
...
# HBase Example
PIO_STORAGE_SOURCES_CASSANDRA_TYPE=cassandra
PIO_STORAGE_SOURCES_CASSANDRA_IP=localhost
PIO_STORAGE_SOURCES_CASSANDRA_PORT=9042
